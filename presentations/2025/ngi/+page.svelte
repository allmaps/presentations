<script module>
  export const title = 'Nationaal Geografisch Instituut'
  export const date = Date.parse('12 May 2025')
</script>
...
<Title>
  ...
  <p class="text-white r-fit-text">NGI - May 12th, 2025</p>
</Title>
...
<section>
  <p>Why build on Allmaps</p>

  <div class="max-w-6xl">
    <span class="fragment text-pink"
      >IIIF is the (upcoming) standard for archives.</span
    ><br />
    <span class="fragment text-orange"
      >More flexibility by separating map scans + georeferencing.</span
    ><br />
    <span class="fragment text-green">
      Pubish archival documents, not just map series.</span
    ><br />
    <span class="fragment text-blue"
      >Build a custom app and invest in Open Source code.</span
    ><br />
    <span class="fragment text-purple">
      Prepare for public (crowdsourcing?) projects.
    </span><br />
  </div>
</section>
